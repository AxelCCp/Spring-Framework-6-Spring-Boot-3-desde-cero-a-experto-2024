...
public class Invoice {
    ...
    public Invoice() {
        ...
        System.out.println(client);                                                 //aqui los datos vienen null.
        System.out.println(description);                                            //aqui los datos vienen null.
    }

    @PostConstruct //SE EJECUTA CUANDO SE CREA ESTE COMPONENTE EN EL CONTEXTO DE LA APLICACION.
    public void init() {
        System.out.println("Creando el componente de la factura");
